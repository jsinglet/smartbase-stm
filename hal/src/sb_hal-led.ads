...
package SB_HAL.LED is
   
   type Brightness_Value is new UInt8 range 0..255;

   type Brightness_Array is array (Natural range<>) of Brightness_Value;
   --type Brightness_Array_Ptr is access all Brightness_Array;
   ...
   procedure Get_Fade_Up_Range(Steps : in out Brightness_Array; Max_Brightness : Integer; Num_Samples : Integer := Default_Num_Samples);
   procedure Get_Fade_Down_Range(Steps : in out Brightness_Array; Max_Brightness : Integer; Num_Samples : Integer := Default_Num_Samples);
