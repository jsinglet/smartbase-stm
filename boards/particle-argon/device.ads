...
package Device is
   ...
   TXD : constant Pin_Type := P1_04;
   RXD : constant Pin_Type := P1_05;
   CTS : constant Pin_Type := P1_07;
   RTS : constant Pin_Type := P1_06;
   BOOT_MODE : constant Pin_Type := P0_16;
   WIFI_EN   : constant Pin_Type := P0_24;
   HOST_WK   : constant Pin_Type := P0_07;
