...
package body LED is
   ...
   begin
      ...
      loop 
         ...
         Log(LED_Log, "Processing Status Changes. Current Status is " & LED_Status_Manager.Get_Status'Image);
         ...
         Log(LED_Log, "Barrier released. Current Status is " & Current_Status'Image);
         ...
         case Current_Status is
            ...
            when FADE_ON => 
               ...
               Log(LED_Log, "Setting status to NONE_FADE_ON");
