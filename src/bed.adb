...
is  
   ...
   begin 
      Device.GPIO.Pin_Mode(This.Head_Up_Pin, SB_HAL.GPIO.Output); 
      Device.GPIO.Pin_Mode(This.Head_Down_Pin, SB_HAL.GPIO.Output); 
      Device.GPIO.Pin_Mode(This.Feet_Up_Pin, SB_HAL.GPIO.Output); 
      Device.GPIO.Pin_Mode(This.Feet_Down_Pin, SB_HAL.GPIO.Output);      
   end Start;
